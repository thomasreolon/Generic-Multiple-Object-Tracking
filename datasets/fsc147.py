import sys
import os
os.chdir('C:/Users/Tom/Desktop/Generic-Multiple-Object-Tracking')
sys.path.append('C:/Users/Tom/Desktop/Generic-Multiple-Object-Tracking')
...
"""
(['H', 'W', 'box_examples_coordinates', 'box_examples_path', 'density_path', 'density_path_fixed', 'img_path', 'points', 'r', 'ratio_h', 'ratio_w'])

(['area', 'iscrowd', 'bbox', 'category_id', 'ignore', 'segmentation', 'image_id', 'id'])
...
class FSCDataset(Dataset):
    ...
    def __init__(self, args, split, transform) -> None:
        ...
        if split == 'train' or split == 'val' :
            path_det = args.fscd_path+'/instances_test.json'
        elif split == 'test': 
            path_det = args.fscd_path+'/instances_val.json'
